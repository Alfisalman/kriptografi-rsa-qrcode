...
<head>
    ...
    <title>Login Aplikasi SKIU</title>
    <link rel="shortcut icon" href="<?= base_url('assets/img/kab.jpg'); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/logodesa.png'); ?>" class="login" />
                <h3 class="text-white mt-2">Aplikasi SKIU Desa Purwasari</h3>
