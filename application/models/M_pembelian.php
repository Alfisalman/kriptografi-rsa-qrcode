...
class M_pembelian extends CI_Model
{
    ...
    var $select = array('p.id_pembelian AS id_pembelian', 'tgl_pembelian', 'count(id_barang) AS jumlah', 'SUM(qty * harga) AS total', 'p.id_user AS id_user', 'fullname', 'nama_supplier', 'p.qrcode'); //data yang akan diambil
    ...
    {
        return $this->db->query("SELECT id_pembelian FROM tbl_pembelian ORDER BY id_pembelian DESC LIMIT 1")->row_array();
    }
}
